...
function Validation() {
	...
	var chamgo = document.getElementById("sample6_extraAddress")
...
<form action="../Controller/JoinController.do" method="post" name="SignUp">
<h3>회원가입</h3>
<br />
<label for="userId">
	<span class="c_imp">*</span> 아이디</label>
<input type="text" Style="width:60%;" name="id" placeholder="4~12자 영문, 대소문자, 숫자로 이루어진 아이디를 입력하세요." id="Id">

<input type="button" value="사용가능여부확인" onclick="ValidateId();"
	style="width:20%; background-color:rgb(97, 87, 87)" display="inline;">

<label for="password">
	<span class="c_imp">*</span> 비밀번호</label>
<input type="password" Style="width:60%;" name="password" placeholder="4~12자 영문 대소문자, 숫자로 이루어진 패스워드를 입력하세요." id="Password">

<input type="button" value="비밀번호확인" onclick="ValidationPass();"
	style="width:20%; background-color:rgb(97, 87, 87)" display="inline;">

<label for="password">
	<span class="c_imp">*</span> 비밀번호 확인</label>
<input type="password" Style="width:60%;" name="passwordCheck" placeholder=" 사용하실 비밀번호를 다시 한 번 입력해주세요"
	id="PasswordCheck">

<input type="button" value="비밀번호확인" onclick="ValidationPassCheck();"
	style="width:20%; background-color:rgb(97, 87, 87)" display="inline;">

<label for="username">
	<span class="c_imp">*</span> 이름(실명)</label>
<input type="text" Style="width:40%;" name="name" placeholder="" id="Name">

<input type="button" value="이름확인" onclick="Validation();"
	style="width:20%; background-color:rgb(97, 87, 87)" display="inline;">

<label for="username"> 생년월일</label>
<input type="text" Style="width:40%; font-size:12px;" name="birth" placeholder=" 예) 20000802" id="Birth">


<label for="address">
	<span class="c_imp">*</span> 주소 </label>
<input type="text" id="sample6_postcode" placeholder="우편번호" name="zipcode" style="width:30%;"
	display="inline;">

<input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기"
	style="width:20%; background-color:rgb(97, 87, 87)" display="inline;">

<input type="text" id="sample6_address" placeholder="주소" name="address" style="width:90%;">

<input type="text" id="sample6_detailAddress" placeholder="상세주소" name="detailAddress" style="width:45%"
	display="inline;">

<input type="text" id="sample6_extraAddress" placeholder="참고항목" name="chamgo" style="width:45%"
	display="inline;">
...
<button type="submit" class="sample">가입하기</button>
<button onclick="" class="sample">취소하기</button>
</form>
